...
STEP3_VERSION=${STEP3_VERSION:-v1_v1}
VERSION=${STEP3_VERSION}_v1
...
# v1_v1 uses unified outline generation script
python "$ROOT_DIR/src/generate-outline_v1.py" \
  --prompt "$ROOT_DIR/prompt/step4-prompt_${VERSION}.txt" \
